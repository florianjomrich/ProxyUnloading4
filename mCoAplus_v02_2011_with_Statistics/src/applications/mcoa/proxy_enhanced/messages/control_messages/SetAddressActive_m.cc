...
{
    return CorrespondentNodeToReceive_var;
}

void SetAddressActive::setCorrespondentNodeToReceive(int CorrespondentNodeToReceive)
{
    this->CorrespondentNodeToReceive_var = CorrespondentNodeToReceive;
}
